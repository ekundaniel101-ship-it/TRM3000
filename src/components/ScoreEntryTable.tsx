...
export function ScoreEntryTable({
  ...
  return (
    <form action={action} className="mt-6">
      ...
      <button
        type="submit"
        className="mt-4 rounded-md bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 text-sm font-medium text-white hover:from-blue-700 hover:to-purple-700"
      >
        Save scores
      </button>
    </form>
